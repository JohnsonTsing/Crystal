...
/// @file
///
/// @brief  Head file for HMM based speech synthesis of Putonghua TTS engine using HTS synthesizer
///
/// <b>History:</b>
/// - Version:  0.1.0
...
#ifndef _CST_TTS_PUTONGHUA_HTS_SYNTHESIZE_H_
#define _CST_TTS_PUTONGHUA_HTS_SYNTHESIZE_H_

#include "ttsputonghua/synth.hts/hts_ssml2lab.h"
...
namespace cst
{
    namespace tts
    {
        ...
        {
            ///
            /// @brief  The class to perform HTS synthesis for Putonghua TTS engine
            ///
...
#endif//_CST_TTS_PUTONGHUA_HTS_SYNTHESIZE_H_
