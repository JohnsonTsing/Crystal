...
/// @file
///
/// @brief    Head file for voice data management of Putonghua (Mandarin) Text-to-Speech (TTS) engine
///
/// <b>History:</b>
/// - Version:  0.1.0
...
#ifndef _CST_TTS_PUTONGHUA_DATA_VOICEDATA_H_
#define _CST_TTS_PUTONGHUA_DATA_VOICEDATA_H_
...
namespace cst
{
    namespace tts
    {
        namespace Putonghua
        {
            ...
            protected:
                /// HTS synthesizer
                CHtsSynthesizer m_htsSynthesizer;
            };
...
#endif//_CST_TTS_PUTONGHUA_DATA_VOICEDATA_H_
