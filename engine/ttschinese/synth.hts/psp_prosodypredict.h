...
/// @file
///
/// @brief  Head file for prosodic prediction module of Putonghua TTS engine
///
/// <b>History:</b>
/// - Version:  0.1.0
...
#ifndef _CST_TTS_PUTONGHUA_PSP_PROSODYPREDICT_H_
#define _CST_TTS_PUTONGHUA_PSP_PROSODYPREDICT_H_
...
namespace cst
{
    namespace tts
    {
        ...
        {
            ///
            /// @brief  The class to perform prosody prediction for Putonghua TTS engine
            ///
...
#endif//_CST_TTS_PUTONGHUA_PSP_PROSODYPREDICT_H_
