...
/// @file
///
/// @brief  Head file for unit segmentation module of Putonghua TTS engine
///
/// <b>History:</b>
/// - Version:  0.1.0
...
#ifndef _CST_TTS_PUTONGHUA_UNITSEG_UNITSEGMENT_H_
#define _CST_TTS_PUTONGHUA_UNITSEG_UNITSEGMENT_H_
...
namespace cst
{
    namespace tts
    {
        ...
        {
            ///
            /// @brief  The class to perform unit segmentation for Putonghua TTS engine
            ///
...
#endif//_CST_TTS_PUTONGHUA_UNITSEG_UNITSEGMENT_H_
